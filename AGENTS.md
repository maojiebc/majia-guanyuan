...
The `SKILL.md` frontmatter (`name: majia-guanyuan`, `description: ...`, `metadata.version: "3.1.8"`) is the universal handshake every agent should parse.
