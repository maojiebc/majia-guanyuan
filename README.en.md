...
<p align="center">
  <img src="./docs/architecture.svg" alt="majia-guanyuan v2.1.11 capability map: three-skill ecosystem (guancli / guanvis-skill / majia-guanyuan) + Part A query + Part B ETL full-stack + Part C front-end injection / Part C-12 HTML application dashboard + Part D V7 publish pipeline (v7 draft/release + customChart autoBootstrap + chip toolbar + mobile phoneLayout ZIP inject) + restaurant BI formulas playbook" width="100%"/>
</p>
